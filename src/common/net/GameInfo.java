...
public class GameInfo {
	...
	/**
	 * <div lang="ja"> 昨夜死亡したエージェントのリストを返します。</div> <div lang="en"> Returns the list
	 * of the agents died last night. </div>
	 * 
	 * @return <div lang="ja">昨夜死亡したエージェントのリスト</div> <div lang="en">the list of the
	 *         agents died last night</div>
	 */
	...
	/**
	 * <div lang="ja"> 存在するRoleを返す </div> <div lang="en"> Returns the roles that
	 * existing in this game. </div>
	 * 
	 * @return <div lang="ja">存在するRoleのリスト</div> <div lang="en">the list of the
	 *         roles</div>
	 */
	 ...
	 *
	 *         <div lang="en">{@code Agent} representing the latest executed
	 *         agent.</div>
	 */
	 ...
	 * 
	 *         <div lang="en">{@code Agent} representing the fox killed by
	 *         curse.</div>
	 */
