...
public class GameInfoToSend {
	 ...
	 *
	 *         <div lang="en">{@code List<VoteToSend>} representing the list of
	 *         votes.</div>
	 */
	 ...
	 *
	 *         <div lang="en">{@code int} representing the index of latest executed
	 *         agent.</div>
	 */
	 ...
	 * 
	 *         <div lang="en">{@code int} representing the agent index of fox killed
	 *         by curse.</div>
	 */
