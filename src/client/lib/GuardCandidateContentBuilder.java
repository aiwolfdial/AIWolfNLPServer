...
public class GuardCandidateContentBuilder extends ContentBuilder {
	...
	/**
	 * <div lang=
	 * "ja">護衛行為について発話するためのGuardCandidateContentBuilderを構築する(主語の指定なし)</div>
	 *
	 * <div lang="en">Constructs a GuardCandidateContentBuilder to utter a guard
	 ...
	 *
	 * <div lang="en">Constructs a GuardCandidateContentBuilder to utter a
	 * guard.</div>
	 * 
	 * @param subject
