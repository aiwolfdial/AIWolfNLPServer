...
import sample.player.SampleBodyguard;
import sample.player.SampleMedium;
import sample.player.SamplePossessed;
import sample.player.SampleSeer;
import sample.player.SampleVillager;
import sample.player.SampleWerewolf;

/**
 * <div lang="ja">役職ごとに実際に使用するプレイヤーを切り替えるプレイヤーの抽象クラス</div>
 *
 * <div lang="en">Abstract player class which switches player actually used
 * according to its role.</div>
 */
